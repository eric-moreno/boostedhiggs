...
def drawTrigEff(h,var_name,var_label,vars_cut,num_sel,plot_title,plot_label,sample):
    print(h)
    #print(h.values())
    ...
    x_scale = x.group("dataset",histl,{"Total":[d.name for d in x.axis("dataset").identifiers()]})
    x_num_scale = x_num.group("dataset",histl,{"Pass":[d.name for d in x.axis("dataset").identifiers()]})
