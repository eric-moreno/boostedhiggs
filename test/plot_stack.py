...
def drawStack(h,sel,var_name,var_label,plottitle,lumifb,vars_cut,regionsel,savename):
...
def getPlots(args):
    ...
    drawStack(h,args.hist,var_name,var_label,args.title,lumifb,vars_cut,args.regions,savename)
